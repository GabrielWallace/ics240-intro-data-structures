...
public interface Event {
	public enum EventType {
		RUNWAY_AVAIL, RUNWAY_ASSIGN, ARRIVAL, DEPARTURE,
	}

	/**
	 * Returns the actual time of this flight event. Note: the for
	 * <code>RUNWAY_AVAL</code> and <code>RUNWAY_ASSIGN</code>event the scheduled
