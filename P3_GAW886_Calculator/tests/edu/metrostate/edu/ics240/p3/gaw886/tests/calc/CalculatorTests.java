...
public class CalculatorTests {
	...
	public void testEnterMethod() {
		...
		for (int i = 0; i < 100; i++) {
			calc.enter(new BigInteger(10, random).toString());
		}
